    ...
    <div className="flex justify-center py-4">
      ...
      >
        ...
        >
          <path
            fillRule="evenodd"
            d="M9.528 1.718a.75.75 0 01.162.819A8.97 8.97 0 009 6a9 9 0 009 9 8.97 8.97 0 004.472-.948.75.75 0 01.818.162.75.75 0 01-.286.948A10.493 10.493 0 0118 16.5a10.5 10.5 0 01-10.5-10.5c0-1.25.22-2.454.62-3.572a.75.75 0 01.948-.286z"
            clipRule="evenodd"
          />
        </svg>
      </button>
